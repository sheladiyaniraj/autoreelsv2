    ...
    <div className="flex min-h-svh flex-col bg-background">
      ...
      <footer className="border-t border-border/60 px-6 py-10 text-center text-sm text-muted-foreground">
        ...
        <div className="mb-4 flex justify-center gap-4">
          <a
            href="https://instagram.com/autoreels.in/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="AutoReels on Instagram"
          ...
          <a
            href="https://www.linkedin.com/company/auto-reels/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="AutoReels on LinkedIn"
            className="hover:text-foreground"
          >
            <svg
              className="size-5"
          ...
          <a
            href="https://x.com/autoreels_in"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="AutoReels on X"
            className="hover:text-foreground"
          >
